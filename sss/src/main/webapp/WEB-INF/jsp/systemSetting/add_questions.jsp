...
<html>
  <head>
    ...
    <link href="../files/新增试题/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="../files/新增试题/data.js"></script>
  ...
  <body>
    ...
    <div id="u16" class="ax_文本">
      ...
      <div id="u17" class="text">
        <p><span>系统设置</span><span>&nbsp;</span><span>&gt;&gt;</span><span>&nbsp;</span><span>题库管理</span><span>设置</span><span> &gt;&gt; 新增</span><span>试题</span></p>
      </div>
    </div>
    ...
    <div id="u233" class="ax_文本">
      ...
      <div id="u234" class="text">
        <p><span style="color:#FF0000;">*</span><span style="color:#333333;">&nbsp;</span></p>
      </div>
    </div>
    ...
    <!-- Styled Button (形状) -->
    <div id="u237" class="ax_形状" data-label="Styled Button">
      <img id="u237_img" class="img " src="../images/修改密码/styled_button_u243.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u237_ann" class="annotation"></div>
    ...
    <div id="u245" class="ax_文本">
      ...
      <div id="u246" class="text">
        <p><span>备</span><span>&nbsp; &nbsp; &nbsp;&nbsp; </span><span>注</span><span>:</span></p>
      </div>
    </div>

    <!-- Unnamed (文本框(单行)) -->
    <div id="u247" class="ax_文本框_单行_" title="根据弹出窗口选择的所属部门，自动填充">
      <input id="u247_input" type="text" value="" title="根据弹出窗口选择的所属部门，自动填充" readonly/>
    </div>
    ...
    <!-- Unnamed (图片) -->
    <div id="u250" class="ax_图片">
      <img id="u250_img" class="img " src="../images/新增用户/u260.png"/>
      <!-- Unnamed () -->
      <div id="u251" class="text"></div>
    </div>

    <!-- Unnamed (文本框(多行)) -->
    <div id="u252" class="ax_文本框_多行_">
      <textarea id="u252_input"></textarea>
    </div>

    <!-- Unnamed (文本框(多行)) -->
    <div id="u253" class="ax_文本框_多行_">
      <textarea id="u253_input"></textarea>
    </div>

    <!-- 组织树 (动态面板) -->
    <div id="u254" class="ax_动态面板" data-label="组织树">
      <div id="u254_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (树) -->
        <div id="u255" class="ax_树节点 treeroot">
          <div id="u255_children" class="u255_children">

            <!-- Unnamed (树节点) -->
            <div id="u256" class="ax_树节点 treenode">
              <!-- Unnamed (形状) -->
              <div id="u257" class="" selectiongroup="u255_tree_group">
        ...
        <!-- Unnamed (图片) -->
        <div id="u259" class="ax_图片">
          <img id="u259_img" class="img " src="../images/新增用户/u267.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Unnamed (图片) -->
        <div id="u263" class="ax_图片">
          <img id="u263_img" class="img " src="../images/新增用户/u271.png"/>
          <!-- Unnamed () -->
          <div id="u264" class="text"></div>
        </div>

        <!-- Unnamed (复选框) -->
        <div id="u265" class="ax_复选框">
          <label for="u265_input">
            <!-- Unnamed () -->
            <div id="u266" class="text"></div>
          </label>
          <input id="u265_input" type="checkbox" value="checkbox"/>
        </div>

        <!-- Unnamed (复选框) -->
        <div id="u267" class="ax_复选框">
          <label for="u267_input">
            <!-- Unnamed () -->
        ...
        <!-- Unnamed (复选框) -->
        <div id="u269" class="ax_复选框">
          <label for="u269_input">
            <!-- Unnamed () -->
            <div id="u270" class="text"></div>
          </label>
          <input id="u269_input" type="checkbox" value="checkbox"/>
        </div>

        <!-- Unnamed (复选框) -->
        <div id="u271" class="ax_复选框">
          <label for="u271_input">
            <!-- Unnamed () -->
            <div id="u272" class="text"></div>
          </label>
          <input id="u271_input" type="checkbox" value="checkbox"/>
        </div>
        ...
        <!-- Styled Button (形状) -->
        <div id="u285" class="ax_形状" data-label="Styled Button">
          <img id="u285_img" class="img " src="../images/新增用户/styled_button_u293.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Styled Button (形状) -->
        <div id="u287" class="ax_形状" data-label="Styled Button">
          <img id="u287_img" class="img " src="../images/新增用户/styled_button_u293.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Unnamed (图片) -->
        <div id="u289" class="ax_图片">
          <img id="u289_img" class="img " src="../images/新增用户/u297.png"/>
          <!-- Unnamed () -->
          <div id="u290" class="text"></div>
        </div>

        <!-- Unnamed (图片) -->
        <div id="u291" class="ax_图片">
          <img id="u291_img" class="img " src="../images/新增用户/u299.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u293" class="ax_图片">
          <img id="u293_img" class="img " src="../images/新增用户/u299.png"/>
          <!-- Unnamed () -->
    ...
    <div id="u296" class="ax_文本">
      ...
      <div id="u297" class="text">
        <p><span>试题</span><span>级别</span><span>:</span></p>
      </div>
    </div>

    <!-- Unnamed (形状) -->
    <div id="u298" class="ax_文本">
    ...
    <!-- Unnamed (下拉列表框) -->
    <div id="u300" class="ax_下拉列表框">
      <select id="u300_input">
        <option selected value="-- 请选择 --">-- 请选择 --</option>
    ...
    <!-- Unnamed (形状) -->
    <div id="u304" class="ax_文本">
      <img id="u304_img" class="img " src="../resources/images/transparent.gif"/>
      <!-- Unnamed () -->
      <div id="u305" class="text">
        <p><span>出题时间</span><span>:</span></p>
      </div>
    </div>

    <!-- Date Input Field (文本框(单行)) -->
    <div id="u306" class="ax_文本框_单行_">
      <input id="u306_input" type="text" value="" data-label="Date Input Field" readonly/>
    </div>

    <!-- Calendar Icon Button (图片) -->
    <div id="u307" class="ax_图片" data-label="Calendar Icon Button">
      <img id="u307_img" class="img " src="../images/待办列表/calendar_icon_button_u360.png"/>
      <!-- Unnamed () -->
      <div id="u308" class="text"></div>
    </div>

    <!-- Date Calendar (动态面板) -->
    <div id="u309" class="ax_动态面板" data-label="Date Calendar">
      <div id="u309_state0" class="panel_state" data-label="Default">

        <!-- Unnamed (图片) -->
        <div id="u310" class="ax_图片">
          <img id="u310_img" class="img " src="../images/待办列表/u363.png"/>
          <!-- Unnamed () -->
          <div id="u311" class="text"></div>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u312" class="ax_形状">
          <img id="u312_img" class="img " src="../images/待办列表/u365.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u314" class="ax_hot_spot" data-label="Date Selection">
        </div>

        <!-- Current Date1 (文本框(单行)) -->
        <div id="u315" class="ax_文本框_单行_">
          <input id="u315_input" type="text" value="" data-label="Current Date1" readonly/>
        </div>
      </div>
    </div>
    ...
    <!-- Unnamed (复选框) -->
    <div id="u318" class="ax_复选框">
      <label for="u318_input">
        <!-- Unnamed () -->
        <div id="u319" class="text"></div>
      </label>
      <input id="u318_input" type="checkbox" value="checkbox" checked/>
    </div>

    <!-- Unnamed (形状) -->
    <div id="u320" class="ax_文本">
      <img id="u320_img" class="img " src="../resources/images/transparent.gif"/>
      <!-- Unnamed () -->
      <div id="u321" class="text">
        <p><span>试题附件</span><span>:</span></p>
      </div>
    </div>

    <!-- Choose File Button (HTML Button) -->
    <div id="u322" class="ax_html_button">
      <input id="u322_input" type="submit" value="上传附件" data-label="Choose File Button"/>
    </div>

    <!-- Choose File Dialog (动态面板) -->
    <div id="u323" class="ax_动态面板" data-label="Choose File Dialog">
      <div id="u323_state0" class="panel_state" data-label="Default">

        <!-- Unnamed (形状) -->
        <div id="u324" class="ax_形状">
          <img id="u324_img" class="img " src="../images/新增试题/u324.png"/>
          <!-- Unnamed () -->
          <div id="u325" class="text"></div>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u326" class="ax_形状">
          <img id="u326_img" class="img " src="../images/新增试题/u326.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u328" class="ax_形状">
          <img id="u328_img" class="img " src="../images/新增试题/u328.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u332" class="ax_形状">
          <img id="u332_img" class="img " src="../images/新增试题/u332.png"/>
          <!-- Unnamed () -->
          <div id="u333" class="text"></div>
        </div>

        <!-- OK Button (形状) -->
        <div id="u334" class="ax_形状" data-label="OK Button">
          <img id="u334_img" class="img " src="../images/新增试题/ok_button_u334.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Unnamed (形状) -->
        <div id="u336" class="ax_形状">
          <img id="u336_img" class="img " src="../images/新增试题/u332.png"/>
          <!-- Unnamed () -->
          <div id="u337" class="text"></div>
        </div>

        <!-- Cancel Button (形状) -->
        <div id="u338" class="ax_形状" data-label="Cancel Button">
          <img id="u338_img" class="img " src="../images/新增试题/ok_button_u334.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u340" class="ax_文本框_单行_">
          <input id="u340_input" type="text" value="My Stuff"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u341" class="ax_形状">
          <img id="u341_img" class="img " src="../images/新增试题/u341.png"/>
          <!-- Unnamed () -->
          <div id="u342" class="text"></div>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u343" class="ax_形状">
          <img id="u343_img" class="img " src="../images/新增试题/u343.png"/>
          <!-- Unnamed () -->
          <div id="u344" class="text"></div>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u345" class="ax_形状">
          <img id="u345_img" class="img " src="../images/新增试题/u343.png"/>
          <!-- Unnamed () -->
          <div id="u346" class="text"></div>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u347" class="ax_形状">
          <img id="u347_img" class="img " src="../images/新增试题/u343.png"/>
          <!-- Unnamed () -->
          <div id="u348" class="text"></div>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u349" class="ax_形状">
          <img id="u349_img" class="img " src="../images/新增试题/u343.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u351" class="ax_形状">
          <img id="u351_img" class="img " src="../images/新增试题/u351.png"/>
          <!-- Unnamed () -->
          <div id="u352" class="text"></div>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u353" class="ax_文本">
        ...
        <div id="u361" class="ax_形状">
          <img id="u361_img" class="img " src="../images/新增试题/u361.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u369" class="ax_菜单" data-label="Custom Image List">
          <img id="u369_menu" class="img " src="../images/新增试题/custom_image_list_u369_menu.png" alt="u369_menu"/>

          <!-- Unnamed (表格) -->
          <div id="u370" class="ax_表格">

            <!-- Filename 1 (菜单项) -->
            <div id="u371" class="ax_表格单元" data-label="Filename 1">
            ...
            <!-- Filename 2 (菜单项) -->
            <div id="u373" class="ax_表格单元" data-label="Filename 2">
            ...
            <!-- Filename 3 (菜单项) -->
            <div id="u375" class="ax_表格单元" data-label="Filename 3">
            ...
            <!-- Filename 4 (菜单项) -->
            <div id="u377" class="ax_表格单元" data-label="Filename 4">
        ...
        <div id="u379" class="ax_形状">
          <img id="u379_img" class="img " src="../images/新增试题/u379.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u381" class="ax_形状">
          <img id="u381_img" class="img " src="../images/新增试题/u379.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Unnamed (文本框(单行)) -->
        <div id="u387" class="ax_文本框_单行_">
          <input id="u387_input" type="text" value="*.csv"/>
        </div>

        <!-- File name (文本框(单行)) -->
        <div id="u388" class="ax_文本框_单行_">
          <input id="u388_input" type="text" value="" data-label="File name"/>
        </div>
      </div>
    </div>
    ...
    <div id="u389" class="ax_文本框_单行_">
      <input id="u389_input" type="text" value="No file selected." data-label="Selected Filename Indicator" maxlength="64"/>
    </div>

    <!-- Spinner (动态面板) -->
    <div id="u390" class="ax_动态面板" data-label="Spinner">
      <div id="u390_state0" class="panel_state" data-label="Default">

        <!-- Unnamed (图片) -->
        <div id="u391" class="ax_图片">
          <img id="u391_img" class="img " src="../images/新增试题/u391.gif"/>
          <!-- Unnamed () -->
