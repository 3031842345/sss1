...
<html>
  <head>
    ...
    <link href="../files/查看职称信息/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="../files/查看职称信息/data.js"></script>
  ...
  <body>
    ...
    <div id="u16" class="ax_文本">
      ...
      <div id="u17" class="text">
        <p><span>系统设置</span><span>&nbsp;</span><span>&gt;&gt;</span><span>&nbsp;</span><span>职</span><span>称</span><span>设置</span><span> &gt;&gt; </span><span>查看</span><span>职</span><span>称</span><span>信息</span></p>
      </div>
    </div>
    ...
    <div id="u228" class="ax_文本框_单行_">
      <input id="u228_input" type="text" value="BDQN-ZC01" readonly/>
    </div>
    ...
    <div id="u231" class="ax_文本框_单行_">
      <input id="u231_input" type="text" value="高级技术顾问" readonly/>
    </div>
    ...
    <!-- Unnamed (文本框(单行)) -->
    <div id="u240" class="ax_文本框_单行_" title="根据弹出窗口选择的所属部门，自动填充">
      <input id="u240_input" type="text" value="产品设计中心" title="根据弹出窗口选择的所属部门，自动填充" readonly/>
    </div>

    <!-- Unnamed (文本框(多行)) -->
    <div id="u241" class="ax_文本框_多行_">
      <textarea id="u241_input" readonly>负责.....</textarea>
    </div>

    <!-- Unnamed (文本框(多行)) -->
    <div id="u242" class="ax_文本框_多行_">
      <textarea id="u242_input" readonly>备注.........</textarea>
    </div>
    ...
    <!-- Unnamed (复选框) -->
    <div id="u245" class="ax_复选框">
      <label for="u245_input">
        <!-- Unnamed () -->
        <div id="u246" class="text"></div>
      </label>
      <input id="u245_input" type="checkbox" value="checkbox" checked/>
    </div>

    <!-- Styled Button (形状) -->
    <div id="u247" class="ax_形状" data-label="Styled Button">
      <img id="u247_img" class="img " src="../images/修改密码/styled_button_u243.png"/>
      <!-- Unnamed () -->
