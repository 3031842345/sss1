  ...
  <body>
    ...
    <div id="u16" class="ax_文本">
      ...
      <div id="u17" class="text">
        <p><span>系统设置</span><span>&nbsp;</span><span>&gt;&gt;</span><span>&nbsp;</span><span>用户管理</span><span> &gt;&gt; 新增用户</span></p>
      </div>
    </div>
    ...
    <div id="u242" class="ax_文本框_单行_">
      <input id="u242_input" type="password" value=""/>
    </div>
    ...
    <div id="u251" class="ax_文本框_单行_" title="根据弹出窗口选择的所属部门，自动填充">
      <input id="u251_input" type="text" value="" title="根据弹出窗口选择的所属部门，自动填充" readonly/>
    </div>
