...
<html>
  <head>
    ...
    <link href="../files/查看试题/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="../files/查看试题/data.js"></script>
  ...
  <body>
    ...
    <div id="u16" class="ax_文本">
      ...
      <div id="u17" class="text">
        <p><span>系统设置</span><span>&nbsp;</span><span>&gt;&gt;</span><span>&nbsp;</span><span>题库管理</span><span>设置</span><span> &gt;&gt; </span><span>查看</span><span>试题</span></p>
      </div>
    </div>
    ...
    <div id="u228" class="ax_文本框_单行_">
      <input id="u228_input" type="text" value="JAVA软件开发试题" readonly/>
    </div>
    ...
    <!-- Unnamed (文本框(单行)) -->
    <div id="u245" class="ax_文本框_单行_" title="根据弹出窗口选择的所属部门，自动填充">
      <input id="u245_input" type="text" value="平台研发部" title="根据弹出窗口选择的所属部门，自动填充" readonly/>
    </div>
    ...
    <!-- Unnamed (文本框(多行)) -->
    <div id="u248" class="ax_文本框_多行_">
      <textarea id="u248_input" readonly>1、陈述面向对象的三大特性..............</textarea>
    </div>

    <!-- Unnamed (文本框(多行)) -->
    <div id="u249" class="ax_文本框_多行_">
      <textarea id="u249_input" readonly>此套试题适用于应聘高级软件开发者，满分100分，80分可进入二面。。。。</textarea>
    </div>

    <!-- Unnamed (下拉列表框) -->
    <div id="u250" class="ax_下拉列表框">
      <select id="u250_input">
        <option value="-- 请选择 --">-- 请选择 --</option>
        <option selected value="JAVA开发">JAVA开发</option>
    ...
    <div id="u256" class="ax_文本框_单行_">
      <input id="u256_input" type="text" value="张三" readonly/>
    </div>
    ...
    <div id="u261" class="ax_文本框_单行_">
      <input id="u261_input" type="text" value="2013-9-8" data-label="Date Input Field" readonly/>
    </div>

    <!-- Unnamed (形状) -->
    <div id="u262" class="ax_文本">
    ...
    <div id="u264" class="ax_复选框">
      ...
      <input id="u264_input" type="checkbox" value="checkbox" checked/>
    </div>
    ...
    <!-- link (形状) -->
    <div id="u270" class="ax_文本" data-label="link">
      <img id="u270_img" class="img " src="../resources/images/transparent.gif"/>
      <!-- Unnamed () -->
      <div id="u271" class="text">
        <p><span style="text-decoration:underline;">JAVA高级开发试题.doc</span></p>
      </div>
    </div>

    <!-- link (形状) -->
    <div id="u272" class="ax_文本" data-label="link">
      <img id="u272_img" class="img " src="../resources/images/transparent.gif"/>
      <!-- Unnamed () -->
      <div id="u273" class="text">
        <p><span style="text-decoration:underline;">JAVA高级开发试题</span><span style="text-decoration:underline;">-参考答案</span><span style="text-decoration:underline;">.doc</span></p>
      </div>
    </div>

    <!-- 附件下载 (动态面板) -->
    <div id="u274" class="ax_动态面板" data-label="附件下载">
      <div id="u274_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (图片) -->
        <div id="u275" class="ax_图片">
          <img id="u275_img" class="img " src="../images/待办处理页面/u309.png"/>
          <!-- Unnamed () -->
