...
<html>
  <head>
    ...
    <link href="../files/修改职称信息/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="../files/修改职称信息/data.js"></script>
  ...
  <body>
    ...
    <div id="u16" class="ax_文本">
      ...
      <div id="u17" class="text">
        <p><span>系统设置</span><span>&nbsp;</span><span>&gt;&gt;</span><span>&nbsp;</span><span>职</span><span>称</span><span>设置</span><span> &gt;&gt; </span><span>修改</span><span>职</span><span>称</span><span>信息</span></p>
      </div>
    </div>
    ...
    <div id="u230" class="ax_文本框_单行_">
      <input id="u230_input" type="text" value="BDQN-ZC01"/>
    </div>
    ...
    <div id="u231" class="ax_文本">
      ...
      <div id="u232" class="text">
        <p><span>职</span><span>称</span><span>编码:</span></p>
      </div>
    </div>

    <!-- Unnamed (文本框(单行)) -->
    <div id="u233" class="ax_文本框_单行_">
      <input id="u233_input" type="text" value="高级技术顾问"/>
    </div>
    ...
    <div id="u234" class="ax_文本">
      ...
      <div id="u235" class="text">
        <p><span>职</span><span>称</span><span>名称</span><span>:</span></p>
      </div>
    </div>
    ...
    <div id="u238" class="ax_文本">
      ...
      <div id="u239" class="text">
        <p><span>职</span><span>称</span><span>描述</span><span>:</span></p>
      </div>
    </div>
