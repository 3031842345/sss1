...
<html>
  <head>
    ...
    <link href="../files/新增职位/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="../files/新增职位/data.js"></script>
  ...
  <body>
    ...
    <div id="u16" class="ax_文本">
      ...
      <div id="u17" class="text">
        <p><span>系统设置</span><span>&nbsp;</span><span>&gt;&gt;</span><span>&nbsp;</span><span>职位</span><span>设置</span><span> &gt;&gt; 新增</span><span>职位</span></p>
      </div>
    </div>
    ...
    <!-- Styled Button (形状) -->
    <div id="u238" class="ax_形状" data-label="Styled Button">
      <img id="u238_img" class="img " src="../images/修改密码/styled_button_u243.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u240" class="ax_形状" data-label="Styled Button">
      <img id="u240_img" class="img " src="../images/修改密码/styled_button_u243.png"/>
      <!-- Unnamed () -->
    ...
    <!-- Unnamed (文本框(单行)) -->
    <div id="u250" class="ax_文本框_单行_" title="根据弹出窗口选择的所属部门，自动填充">
      <input id="u250_input" type="text" value="" title="根据弹出窗口选择的所属部门，自动填充" readonly/>
    </div>

    <!-- Unnamed (形状) -->
    <div id="u251" class="ax_文本">
    ...
    <!-- Unnamed (图片) -->
    <div id="u253" class="ax_图片">
      <img id="u253_img" class="img " src="../images/新增用户/u260.png"/>
      <!-- Unnamed () -->
      <div id="u254" class="text"></div>
    </div>

    <!-- Unnamed (文本框(多行)) -->
    <div id="u255" class="ax_文本框_多行_">
      <textarea id="u255_input"></textarea>
    </div>

    <!-- Unnamed (文本框(多行)) -->
    <div id="u256" class="ax_文本框_多行_">
      <textarea id="u256_input"></textarea>
    </div>
    ...
    <!-- Unnamed (复选框) -->
    <div id="u259" class="ax_复选框">
      <label for="u259_input">
        <!-- Unnamed () -->
        <div id="u260" class="text"></div>
      </label>
      <input id="u259_input" type="checkbox" value="checkbox" checked/>
    </div>

    <!-- 组织树 (动态面板) -->
    <div id="u261" class="ax_动态面板" data-label="组织树">
      <div id="u261_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (树) -->
        <div id="u262" class="ax_树节点 treeroot">
          <div id="u262_children" class="u262_children">

            <!-- Unnamed (树节点) -->
            <div id="u263" class="ax_树节点 treenode">
              <!-- Unnamed (形状) -->
              <div id="u264" class="" selectiongroup="u262_tree_group">
        ...
        <!-- Unnamed (图片) -->
        <div id="u266" class="ax_图片">
          <img id="u266_img" class="img " src="../images/新增用户/u267.png"/>
          <!-- Unnamed () -->
          <div id="u267" class="text"></div>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u268" class="ax_文本">
        ...
        <!-- Unnamed (图片) -->
        <div id="u270" class="ax_图片">
          <img id="u270_img" class="img " src="../images/新增用户/u271.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Styled Button (形状) -->
        <div id="u292" class="ax_形状" data-label="Styled Button">
          <img id="u292_img" class="img " src="../images/新增用户/styled_button_u293.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Styled Button (形状) -->
        <div id="u294" class="ax_形状" data-label="Styled Button">
          <img id="u294_img" class="img " src="../images/新增用户/styled_button_u293.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u296" class="ax_图片">
          <img id="u296_img" class="img " src="../images/新增用户/u297.png"/>
          <!-- Unnamed () -->
          <div id="u297" class="text"></div>
        </div>

        <!-- Unnamed (图片) -->
        <div id="u298" class="ax_图片">
          <img id="u298_img" class="img " src="../images/新增用户/u299.png"/>
          <!-- Unnamed () -->
          <div id="u299" class="text"></div>
        </div>

        <!-- Unnamed (图片) -->
        <div id="u300" class="ax_图片">
          <img id="u300_img" class="img " src="../images/新增用户/u299.png"/>
          <!-- Unnamed () -->
    ...
    <div id="u302" class="ax_文本">
      ...
      <div id="u303" class="text">
        <p><span>职位</span><span>分类</span><span>:</span></p>
      </div>
    </div>
