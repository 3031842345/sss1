  ...
  <body>
    ...
    <div id="u16" class="ax_文本">
      ...
      <div id="u17" class="text">
        <p><span>系统设置</span><span>&nbsp;</span><span>&gt;&gt;</span><span>&nbsp;</span><span>用户管理</span><span> &gt;&gt; </span><span>修改</span><span>用户</span><span>信息</span></p>
      </div>
    </div>
    ...
    <div id="u228" class="ax_文本框_单行_">
      <input id="u228_input" type="text" value="hanlu"/>
    </div>
    ...
    <div id="u231" class="ax_文本框_单行_">
      <input id="u231_input" type="text" value="韩露"/>
    </div>
    ...
    <!-- Unnamed (文本框(单行)) -->
    <div id="u242" class="ax_文本框_单行_">
      <input id="u242_input" type="password" value="123456"/>
    </div>
    ...
    <div id="u243" class="ax_文本">
      ...
      <div id="u244" class="text">
        <p><span>密</span><span>&nbsp; &nbsp; &nbsp;&nbsp; </span><span>码</span><span>:</span></p>
      </div>
    </div>
    ...
    <!-- Unnamed (文本框(单行)) -->
    <div id="u251" class="ax_文本框_单行_" title="根据弹出窗口选择的所属部门，自动填充">
      <input id="u251_input" type="text" value="人力资源中心" title="根据弹出窗口选择的所属部门，自动填充" readonly/>
    </div>
    ...
    <div id="u256" class="ax_文本框_单行_">
      <input id="u256_input" type="text" value="13588888888"/>
    </div>
    ...
    <!-- Unnamed (下拉列表框) -->
    <div id="u259" class="ax_下拉列表框">
      <select id="u259_input">
        ...
        <option selected value="人力资源部负责人">人力资源部负责人</option>
    ...
    <div id="u260" class="ax_图片">
      <img id="u260_img" class="img " src="../images/新增用户/u260.png"/>
      <!-- Unnamed () -->
      <div id="u261" class="text"></div>
    </div>

    <!-- 组织树 (动态面板) -->
    <div id="u262" class="ax_动态面板" data-label="组织树">
      <div id="u262_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (树) -->
        <div id="u263" class="ax_树节点 treeroot">
          <div id="u263_children" class="u263_children">

            <!-- Unnamed (树节点) -->
            <div id="u264" class="ax_树节点 treenode">
              <!-- Unnamed (形状) -->
              <div id="u265" class="" selectiongroup="u263_tree_group">
        ...
        <!-- Unnamed (图片) -->
        <div id="u267" class="ax_图片">
          <img id="u267_img" class="img " src="../images/新增用户/u267.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Unnamed (图片) -->
        <div id="u271" class="ax_图片">
          <img id="u271_img" class="img " src="../images/新增用户/u271.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Styled Button (形状) -->
        <div id="u293" class="ax_形状" data-label="Styled Button">
          <img id="u293_img" class="img " src="../images/新增用户/styled_button_u293.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Styled Button (形状) -->
        <div id="u295" class="ax_形状" data-label="Styled Button">
          <img id="u295_img" class="img " src="../images/新增用户/styled_button_u293.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Unnamed (图片) -->
        <div id="u297" class="ax_图片">
          <img id="u297_img" class="img " src="../images/新增用户/u297.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u299" class="ax_图片">
          <img id="u299_img" class="img " src="../images/新增用户/u299.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u301" class="ax_图片">
          <img id="u301_img" class="img " src="../images/新增用户/u299.png"/>
          <!-- Unnamed () -->
